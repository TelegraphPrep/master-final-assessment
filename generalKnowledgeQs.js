...
1. How do you access the third item in an array?
  ...
  To access an element in an array you have to use bracket notation, to access the third element you write:
...
1. What are the two ways you can access a particular key in an object? When do you use which and why?
  ...
  The two ways to access a particular key in an object are:
...
2. What is the difference between '=' and '==='?
  ...
  '=' is to assign values and '===' is to compare  
...
4. a) What is scope?
  ...
  The scope is the set of variables, objects, and functions you have access to. In JavaScript functions create it's own scope call local scope


b) What happens if you try to call a variable that's defined in the parent scope from within the child scope?

  The child scope will call the variable since child scope has access to the global scope.
...
Prompt 1: create a function that takes in an array of numbers as a parameter, iterates through the array, and returns true if EVERY number in the array is even, and false otherwise.
  ...
  //create a function that takes an array as a parameter
    ...
    //for each element check if the value modulo(%) two is equal to zero
